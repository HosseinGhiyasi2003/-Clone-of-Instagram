...
const PostFooter = () => {
  ...
  return (
    <div className="mt-4">
      ...
      <p className="flex gap-2 text-white text-[14px] md:text-[16px]">
      ...
      <div className="w-full flex items-center justify-between relative">
        ...
        <button className="absolute text-[12px] md:text-[16px] right-2 text-[#4cb5f7] hover:text-white ">Post</button>
      </div>
    </div>
  );
};
